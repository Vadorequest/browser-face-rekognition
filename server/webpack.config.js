...
module.exports = {
  ...
  plugins: [
    // XXX We need to overwrite NODE_ENV because WEBPACK allows only two stages "production" and "development" which causes issues with our "staging" environment
    ...
    new SentryCliPlugin({
      ...
      dryRun: slsw.lib.webpack.isLocal, // XXX dryRun is true when we work locally, avoid sending source files to Sentry each time the server is started locally.
